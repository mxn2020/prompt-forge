...
export default function HistoryPage() {
  return (<div style={{ padding: "var(--space-6)", maxWidth: 1000 }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-2)" }}>{runs.map(r => (<Card key={r.id} padding="sm">
      <div style={{ display: "flex", alignItems: "center", gap: "var(--space-4)" }}>
        ...
        <div style={{ flex: 1 }}><strong>{r.prompt}</strong> <Badge variant="warning" size="sm" style={{ marginLeft: 8 }}>{r.version}</Badge></div>
